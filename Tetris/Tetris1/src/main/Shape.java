...
public class Shape {
	...
	private int normal = 600, fast = 50, level2 = 350, level3 = 270, level4 = 200, level5 = 150;
	...
	public Shape(int[][] coords, BufferedImage block, Board board, int color){
		...
		y = 0;
		delay = normal;
		if(Board.getScore() >= 3) delay = level2;
		if(Board.getScore() == 8) delay = 0;
		if(Board.getScore() >= 8) delay = level3;
		if(Board.getScore() == 20) delay = 0;
		if(Board.getScore() >= 20) delay = level4;
		if(Board.getScore() == 40) delay = 0;
		if(Board.getScore() >= 40) delay = level5;
		time = 0;
	...
	public void speedDown(){
		if(Board.getScore() < 3) delay = normal;
		if(Board.getScore() >= 3 & Board1.getScore() <8) delay = level2;
		if(Board.getScore() >= 8 & Board1.getScore() <20) delay = level3;
		if(Board.getScore() >= 20 & Board1.getScore() <40) delay = level4;
		if(Board.getScore() >= 40) delay = level5;
	}
