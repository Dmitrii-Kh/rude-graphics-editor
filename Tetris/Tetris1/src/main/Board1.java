...
public class Board1 extends JPanel implements KeyListener, MouseListener, MouseMotionListener{
	...
	private Shape1[] shapes = new Shape1[7];
		
	private static Shape1 currentShape, nextShape;
	...
	public void paintComponent(Graphics g) {
		...
		g.drawString("SCORE", Window.WIDTH/2 - 125, Window.HEIGHT/2);
		g.drawString(score+"", Window.WIDTH/2 - 125, Window.HEIGHT/2 + 30);
	...
	public void setNextShape(){
		...
		nextShape = new Shape1(shapes[index].getCoords(), shapes[index].getBlock(), this, shapes[index].getColor());
	}
